...
export default function handler(req, res) {
  ...
  res.setHeader("Access-Control-Expose-Headers", "Content-Range").json(posts);
  //   res.setHeader("Content-Range", "posts 0-9/100").json(posts);
}
...
// })
//   .get((req, res) => {
//     res.setHeader("Content-Range", "posts 0-10/30").json(posts);
//   })
//   .post((req, res) => {
