              ...
              <div className=" col-lg-11">
                <header>
                  <h4 className={styles.boldText}>
                    A specialised team of finance specialists at All Motors Ltd
                    is here to assist you with your inquiry.
                  </h4>
                  <p className={styles.supportText}>
                    Because of our connections with high street lenders and
                    specialised auto finance companies, we have assisted
                    hundreds of clients in finding the ideal financing option
                    for their budget. <br />
                    <br />
                ...
                <div className="mt-4">
                  ...
                  <p className={styles.supportText}>
                    Please complete the application below so that we can
                    instantly offer you with a very appropriate options.
                    <br />
